class iCaRL():
    ...
    def NME(self, data, exemplars, net, n_classes):
      ...
      for key in exemplars:
        ...
        loader = DataLoader(exemplars[key], batch_size=params['BATCH_SIZE'], shuffle=False, num_workers=4, drop_last=False)
    ...
    def update_representation(self, new_data, exemplars, net, n_classes):
        ...
        loader = DataLoader(data, batch_size=params['BATCH_SIZE'], shuffle=True, num_workers=4, drop_last=True)
        if n_classes != 10:
